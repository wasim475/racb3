  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 md:px-0 space-y-8 bangla">
        {/* Title */}
        <h1 className="text-lg  font-extrabold mb-2">{note.title}</h1>
        ...
        <div className="flex items-center space-x-4  text-sm md:text-base">
          ...
          <div>
            ...
            {note.audioPath && <AudioPlayer audioLink={note?.audioPath} />}
          </div>
        </div>
        ...
        {user?.id === note.ownerId && <DelEdit id={note?._id} />}
      </div>
    </>
  );
};
